...
// Checking if guader rails exist and if they follow the convention
#ifndef SENECA_TOY_H
...
int main(int argc, char** argv)
{
	...
	// Confirming Order
	{
		...
		refToOrder = order2; // testing for self assignment
...

	{
		...
		//   create copies of the original toy
		seneca::Toy* toys[]{
		...
		//to updat some toys in main
		// should not affect child
		toys[0]->update(6);
		toys[2]->update(4);
